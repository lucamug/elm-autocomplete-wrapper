...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				fieldValue: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$getMenuItemAtId, model.menuItems, id),
...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$init = F2(
	function (fieldId, menuItems1) {
		return {fieldValue: '', fieldId: fieldId, menuItems: menuItems1, state: _thebritican$elm_autocomplete$Autocomplete$empty, howManyToShow: 50, selectedMenuItem: _elm_lang$core$Maybe$Nothing, showMenu: false, focus: false, preventingBlur: false, preventingFocus: false};
	});
			...
			switch (_p8.ctor) {
				case 'SetQuery':
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{fieldValue: _p10, showMenu: showMenu, selectedMenuItem: _elm_lang$core$Maybe$Nothing}),
						{ctor: '[]'});
				case 'SetAutoState':
					if (!model.focus) {
						return A2(
						...
						var _p11 = A5(
							...
							A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$updateConfig, model.fieldId, originMessage),
							_p8._0,
							model.howManyToShow,
							model.state,
							A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$acceptableItems, model.fieldValue, model.menuItems));
				...
				case 'SelectMenuItemMouse':
					...
					return {
						...
						_1: A2(
							...
							function (_p15) {
								return A2(originMessage, model.fieldId, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$NoOpAutocom);
							},
				...
				case 'HandleEscape':
					...
					var escapedModel = function () {
						...
						if (_p16.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(model.fieldValue, _p16._0) ? _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$resetInput(model) : handleEscape;
						} else {
							return handleEscape;
						}
					}();
			...
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onMouseDown(
						A2(originMessage, model.fieldId, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$PreventFocusAndBlur)),
					_1: {ctor: '[]'}
				}
			},
			{
			...
			A2(
				...
				function (code) {
					return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(
						A2(originMessage, model.fieldId, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$NoOpAutocom)) : (_elm_lang$core$Native_Utils.eq(code, 27) ? _elm_lang$core$Result$Ok(
						A2(originMessage, model.fieldId, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$HandleEscape)) : _elm_lang$core$Result$Err('not handling that key'));
				},
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onFocus(
											A2(originMessage, model.fieldId, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$OnFocusAutocom)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onBlur(
												A2(originMessage, model.fieldId, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$OnBlurAutocom)),
											_1: {
												ctor: '::',
...
var _lucamug$elm_autocomplete_wrapper$Main$init = {
	ctor: '_Tuple2',
	_0: {
		field1: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$init, 'id1', _lucamug$elm_autocomplete_wrapper$Main$menuItems1),
		field2: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$init, 'id2', _lucamug$elm_autocomplete_wrapper$Main$menuItems2),
		field3: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$init, 'id3', _lucamug$elm_autocomplete_wrapper$Main$menuItems3)
	},
...
var _lucamug$elm_autocomplete_wrapper$Main$update = F2(
	function (msg, model) {
		...
		var _p1 = msgConverter(msg);
		var fieldId = _p1._0;
		var autocomMsg = _p1._1;
		if (_elm_lang$core$Native_Utils.eq(fieldId, model.field1.fieldId)) {
			var _p2 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, autocomMsg, model.field1, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
			var newModel = _p2._0;
			var newMsg = _p2._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
			...
			if (_elm_lang$core$Native_Utils.eq(fieldId, model.field2.fieldId)) {
				var _p3 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, autocomMsg, model.field2, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
				var newModel = _p3._0;
				var newMsg = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
				...
				if (_elm_lang$core$Native_Utils.eq(fieldId, model.field3.fieldId)) {
					var _p4 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, autocomMsg, model.field3, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
					var newModel = _p4._0;
					var newMsg = _p4._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Programming Language'),
								_1: {
									ctor: '::',
			...
			_0: A2(
				...
				function (_p5) {
					return A2(
						...
						model.field1.fieldId,
						_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetAutoState(_p5));
				},
			...
			_1: {
				...
				_0: A2(
					...
					function (_p6) {
						return A2(
							_lucamug$elm_autocomplete_wrapper$Main$OriginMessage,
							model.field2.fieldId,
							_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetAutoState(_p6));
					},
					_thebritican$elm_autocomplete$Autocomplete$subscription),
				_1: {
					ctor: '::',
