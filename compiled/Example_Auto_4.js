...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$viewConfig = function () {
	var customizedLi = F3(
...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$acceptableItems = F2(
...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$getMenuItemAtId = F2(
...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				value: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$getMenuItemAtId, model.menuItems, id),
				selectedMenuItem: _elm_lang$core$Maybe$Just(
					A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$getMenuItemAtId, model.menuItems, id))
			});
	});
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$removeSelection = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{selectedMenuItem: _elm_lang$core$Maybe$Nothing});
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$resetMenu = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{state: _thebritican$elm_autocomplete$Autocomplete$empty, showMenu: false});
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$resetInput = function (model) {
	return _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$resetMenu(
		_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$removeSelection(
			_elm_lang$core$Native_Utils.update(
				model,
				{value: ''})));
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$init = F3(
...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$NoOpAutocom = {ctor: 'NoOpAutocom'};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$Reset = {ctor: 'Reset'};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$PreventFocusAndBlur = {ctor: 'PreventFocusAndBlur'};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$OnBlurAutocom = {ctor: 'OnBlurAutocom'};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$OnFocusAutocom = {ctor: 'OnFocusAutocom'};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$HandleEscape = {ctor: 'HandleEscape'};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$PreviewMenuItem = function (a) {
	return {ctor: 'PreviewMenuItem', _0: a};
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SelectMenuItemMouse = function (a) {
	return {ctor: 'SelectMenuItemMouse', _0: a};
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SelectMenuItemKeyboard = function (a) {
	return {ctor: 'SelectMenuItemKeyboard', _0: a};
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$Wrap = function (a) {
	return {ctor: 'Wrap', _0: a};
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$updateConfig = F2(
						...
						return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? A2(
							...
							function (_p1) {
								return A2(
									originMessage,
									msgId,
									_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$PreviewMenuItem(_p1));
							},
							...
							function (_p2) {
								return A2(
									originMessage,
									msgId,
									_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SelectMenuItemKeyboard(_p2));
							},
							maybeId) : _elm_lang$core$Maybe$Just(
							A2(originMessage, msgId, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$Reset)));
					}),
				onTooLow: _elm_lang$core$Maybe$Just(
					function (_p3) {
						return A2(
							originMessage,
							msgId,
							_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$Wrap(_p3));
					}(false)),
				onTooHigh: _elm_lang$core$Maybe$Just(
					function (_p4) {
						return A2(
							originMessage,
							msgId,
							_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$Wrap(_p4));
					}(true)),
					...
					return _elm_lang$core$Maybe$Just(
						function (_p7) {
							return A2(
								originMessage,
								msgId,
								_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SelectMenuItemMouse(_p7));
						}(id));
				},
				separateSelections: false
			});
	});
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update = F4(
			...
			switch (_p8.ctor) {
				case 'SetQuery':
					...
					var showMenu = function (_p9) {
						...
						A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$acceptableItems, _p10, model.menuItems));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'SetAutoState':
					if (!model.focus) {
						...
						var _p11 = A5(
							...
							A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$updateConfig, model.id, originMessage),
							_p8._0,
							model.howManyToShow,
							model.state,
							A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$acceptableItems, model.value, model.menuItems));
				...
				case 'Wrap':
					...
					if (_p14.ctor === 'Just') {
						var _v7 = _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$Reset,
							_v8 = model,
							_v9 = originMessage,
							_v10 = msgConverter;
						msg = _v7;
				...
				case 'SelectMenuItemKeyboard':
					var newModel = _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$resetMenu(
						A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$setQuery, model, _p8._0));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						newModel,
						{ctor: '[]'});
				case 'SelectMenuItemMouse':
					...
					return {
						...
						_1: A2(
							...
							function (_p15) {
								return A2(originMessage, model.id, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$NoOpAutocom);
							},
				...
				case 'PreviewMenuItem':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								selectedMenuItem: _elm_lang$core$Maybe$Just(
									A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$getMenuItemAtId, model.menuItems, _p8._0))
							}),
						{ctor: '[]'});
				case 'HandleEscape':
					var validOptions = !_elm_lang$core$List$isEmpty(
						A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$acceptableItems, model.value, model.menuItems));
					var handleEscape = validOptions ? _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$resetMenu(
						_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$removeSelection(model)) : _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$resetInput(model);
					var escapedModel = function () {
						var _p16 = model.selectedMenuItem;
						if (_p16.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(model.value, _p16._0) ? _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$resetInput(model) : handleEscape;
						} else {
							return handleEscape;
						}
					}();
...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetAutoState = function (a) {
	return {ctor: 'SetAutoState', _0: a};
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$viewMenu = F2(
			...
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onMouseDown(
						A2(originMessage, model.id, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$PreventFocusAndBlur)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					function (_p17) {
						return A2(
							originMessage,
							model.id,
							_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetAutoState(_p17));
					},
					A4(
						_thebritican$elm_autocomplete$Autocomplete$view,
						_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$viewConfig,
						model.howManyToShow,
						model.state,
						A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$acceptableItems, model.value, model.menuItems))),
				_1: {ctor: '[]'}
...
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetQuery = function (a) {
	return {ctor: 'SetQuery', _0: a};
};
var _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$view = F2(
	function (model, originMessage) {
		...
		var menu = model.showMenu ? {
			ctor: '::',
			_0: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$viewMenu, model, originMessage),
			_1: {ctor: '[]'}
		} : {ctor: '[]'};
			...
			A2(
				...
				function (code) {
					return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(
						A2(originMessage, model.id, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$NoOpAutocom)) : (_elm_lang$core$Native_Utils.eq(code, 27) ? _elm_lang$core$Result$Ok(
						A2(originMessage, model.id, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$HandleEscape)) : _elm_lang$core$Result$Err('not handling that key'));
				},
										...
										_0: _elm_lang$html$Html_Events$onInput(
											function (_p21) {
												return A2(
													originMessage,
													model.id,
													_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetQuery(_p21));
											}),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onFocus(
												A2(originMessage, model.id, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$OnFocusAutocom)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onBlur(
													A2(originMessage, model.id, _lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$OnBlurAutocom)),
												_1: {
													ctor: '::',
...
var _lucamug$elm_autocomplete_wrapper$Main$menuItems3 = {
	ctor: '::',
	_0: 'Blue',
	_1: {
		ctor: '::',
...
var _lucamug$elm_autocomplete_wrapper$Main$menuItems2 = {
	ctor: '::',
	_0: 'ABAP',
	_1: {
		ctor: '::',
...
var _lucamug$elm_autocomplete_wrapper$Main$menuItems1 = {
	ctor: '::',
	_0: 'Alabama',
	_1: {
		ctor: '::',
...
var _lucamug$elm_autocomplete_wrapper$Main$init = {
	ctor: '_Tuple2',
	_0: {
		field1: A3(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$init, 'id1', 'State', _lucamug$elm_autocomplete_wrapper$Main$menuItems1),
		field2: A3(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$init, 'id2', 'Language', _lucamug$elm_autocomplete_wrapper$Main$menuItems2),
		field3: A3(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$init, 'id3', 'Color', _lucamug$elm_autocomplete_wrapper$Main$menuItems3)
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _lucamug$elm_autocomplete_wrapper$Main$Model = F3(
	function (a, b, c) {
		return {field1: a, field2: b, field3: c};
	});
var _lucamug$elm_autocomplete_wrapper$Main$OriginMessage = F2(
	function (a, b) {
		return {ctor: 'OriginMessage', _0: a, _1: b};
	});
var _lucamug$elm_autocomplete_wrapper$Main$update = F2(
	function (msg, model) {
		...
		var _p7 = _p2._0;
		var _p6 = _p2._1;
		if (_elm_lang$core$Native_Utils.eq(_p7, model.field1.id)) {
			var _p3 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, _p6, model.field1, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
			var newModel = _p3._0;
			var newMsg = _p3._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
			...
			if (_elm_lang$core$Native_Utils.eq(_p7, model.field2.id)) {
				var _p4 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, _p6, model.field2, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
				var newModel = _p4._0;
				var newMsg = _p4._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
				...
				if (_elm_lang$core$Native_Utils.eq(_p7, model.field3.id)) {
					var _p5 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, _p6, model.field3, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
					var newModel = _p5._0;
					var newMsg = _p5._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
...
var _lucamug$elm_autocomplete_wrapper$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				function (_p8) {
					return A2(
						_lucamug$elm_autocomplete_wrapper$Main$OriginMessage,
						model.field1.id,
						_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetAutoState(_p8));
				},
				...
				_0: A2(
					...
					function (_p9) {
						return A2(
							_lucamug$elm_autocomplete_wrapper$Main$OriginMessage,
							model.field2.id,
							_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetAutoState(_p9));
					},
					_thebritican$elm_autocomplete$Autocomplete$subscription),
				_1: {
					ctor: '::',
					_0: A2(
						...
						function (_p10) {
							return A2(
								_lucamug$elm_autocomplete_wrapper$Main$OriginMessage,
								model.field3.id,
								_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetAutoState(_p10));
						},
						_thebritican$elm_autocomplete$Autocomplete$subscription),
					_1: {ctor: '[]'}
				}
...
var _lucamug$elm_autocomplete_wrapper$Main$Colored = {ctor: 'Colored'};
var _lucamug$elm_autocomplete_wrapper$Main$Monochrome = function (a) {
	return {ctor: 'Monochrome', _0: a};
};
var _lucamug$elm_autocomplete_wrapper$Main$Black = {ctor: 'Black'};
var _lucamug$elm_autocomplete_wrapper$Main$White = {ctor: 'White'};
var _lucamug$elm_autocomplete_wrapper$Main$Blue = {ctor: 'Blue'};
var _lucamug$elm_autocomplete_wrapper$Main$LightBlue = {ctor: 'LightBlue'};
var _lucamug$elm_autocomplete_wrapper$Main$Green = {ctor: 'Green'};
var _lucamug$elm_autocomplete_wrapper$Main$Orange = {ctor: 'Orange'};
var _lucamug$elm_autocomplete_wrapper$Main$logoElm = F2(
	function (logoColor, size) {
		var c = function () {
			var _p11 = logoColor;
			if (_p11.ctor === 'Colored') {
				return {
					c1: _lucamug$elm_autocomplete_wrapper$Main$cssRgb(_lucamug$elm_autocomplete_wrapper$Main$Orange),
					c2: _lucamug$elm_autocomplete_wrapper$Main$cssRgb(_lucamug$elm_autocomplete_wrapper$Main$Green),
					c3: _lucamug$elm_autocomplete_wrapper$Main$cssRgb(_lucamug$elm_autocomplete_wrapper$Main$LightBlue),
					c4: _lucamug$elm_autocomplete_wrapper$Main$cssRgb(_lucamug$elm_autocomplete_wrapper$Main$Blue)
				};
			} else {
				var _p12 = _p11._0;
				return {
					c1: _lucamug$elm_autocomplete_wrapper$Main$cssRgb(_p12),
					c2: _lucamug$elm_autocomplete_wrapper$Main$cssRgb(_p12),
					c3: _lucamug$elm_autocomplete_wrapper$Main$cssRgb(_p12),
					c4: _lucamug$elm_autocomplete_wrapper$Main$cssRgb(_p12)
				};
			}
		}();
...
var _lucamug$elm_autocomplete_wrapper$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					ctor: '::',
					_0: A2(
						_lucamug$elm_autocomplete_wrapper$Main$logoElm,
						_lucamug$elm_autocomplete_wrapper$Main$Monochrome(_lucamug$elm_autocomplete_wrapper$Main$LightBlue),
						'100px'),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Elm Autocomplete'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('https://medium.com/@l.mugnaini/autocomplete-widget-in-elm-4927b8e275db'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('https://github.com/lucamug/elm-autocomplete-wrapper'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$view, model.field1, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage),
						_1: {
							ctor: '::',
							_0: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$view, model.field2, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage),
							_1: {
								ctor: '::',
								_0: A2(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$view, model.field3, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _lucamug$elm_autocomplete_wrapper$Main$main = _elm_lang$html$Html$program(
	{init: _lucamug$elm_autocomplete_wrapper$Main$init, view: _lucamug$elm_autocomplete_wrapper$Main$view, update: _lucamug$elm_autocomplete_wrapper$Main$update, subscriptions: _lucamug$elm_autocomplete_wrapper$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _lucamug$elm_autocomplete_wrapper$Main$main !== 'undefined') {
    _lucamug$elm_autocomplete_wrapper$Main$main(Elm['Main'], 'Main', undefined);
}
