			...
			},
			{
				...
				_0: A2(
					_elm_lang$svg$Svg$path,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$d('M162 153l70-70H92z'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
					...
					_1: {
						...
						_0: A2(
							_elm_lang$svg$Svg$path,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$d('M9 0l70 70h153L162 0zm238 85l77 76-77 77-76-77z'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								_elm_lang$svg$Svg$path,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$d('M323 144V0H180z'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									_elm_lang$svg$Svg$path,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$d('M153 162L0 9v305z'),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
								_1: {
									...
									_0: A2(
										_elm_lang$svg$Svg$path,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$d('M256 247l67 67V179z'),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
									_1: {
										...
										_0: A2(
											_elm_lang$svg$Svg$path,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$d('M162 171L9 323h305z'),
													_1: {ctor: '[]'}
												}
											},
											{ctor: '[]'}),
...
var _lucamug$elm_autocomplete_wrapper$Main$update = F2(
	function (msg, model) {
		...
		var _p6 = _p1._0;
		var _p5 = _p1._1;
		if (_elm_lang$core$Native_Utils.eq(_p6, model.field1.id)) {
			var _p2 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, _p5, model.field1, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
			var newModel = _p2._0;
			var newMsg = _p2._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
			...
			if (_elm_lang$core$Native_Utils.eq(_p6, model.field2.id)) {
				var _p3 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, _p5, model.field2, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
				var newModel = _p3._0;
				var newMsg = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
				...
				if (_elm_lang$core$Native_Utils.eq(_p6, model.field3.id)) {
					var _p4 = A4(_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$update, _p5, model.field3, _lucamug$elm_autocomplete_wrapper$Main$OriginMessage, msgConverter);
					var newModel = _p4._0;
					var newMsg = _p4._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_lucamug$elm_autocomplete_wrapper$Main$logoElm, '100px', '100px'),
					_1: {
						ctor: '::',
						_0: A2(
			...
			_0: A2(
				...
				function (_p7) {
					return A2(
						...
						model.field1.id,
						_lucamug$elm_autocomplete_wrapper$AutocompleteWrapper$SetAutoState(_p7));
				},
...
if (typeof _lucamug$elm_autocomplete_wrapper$Main$main !== 'undefined') {
    _lucamug$elm_autocomplete_wrapper$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"AutocompleteWrapper.Msg":{"args":[],"tags":{"PreviewMenuItem":["String"],"SelectMenuItemMouse":["String"],"NoOpAutocom":[],"HandleEscape":[],"OnBlurAutocom":[],"Wrap":["Bool"],"SetAutoState":["Autocomplete.Msg"],"Reset":[],"SetQuery":["String"],"PreventFocusAndBlur":[],"OnFocusAutocom":[],"SelectMenuItemKeyboard":["String"]}},"Autocomplete.Msg":{"args":[],"tags":{"Msg":["Autocomplete.Autocomplete.Msg"]}},"Autocomplete.Autocomplete.Msg":{"args":[],"tags":{"MouseLeave":["String"],"WentTooHigh":[],"WentTooLow":[],"MouseClick":["String"],"KeyDown":["Char.KeyCode"],"NoOp":[],"MouseEnter":["String"]}},"Main.Msg":{"args":[],"tags":{"OriginMessage":["String","AutocompleteWrapper.Msg"]}}},"aliases":{"Char.KeyCode":{"args":[],"type":"Int"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
