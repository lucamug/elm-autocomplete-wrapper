...
var _lucamug$elm_autocomplete_wrapper$Main$logoElm = F3(
	function (color, x, y) {
		var blue = '#5A6378';
		var lightBlue = '#60B5CC';
		var green = '#7FD13B';
		var orange = '#F0AD00';
		var c = function () {
			var _p0 = color;
			switch (_p0.ctor) {
				case 'Colored':
					return {c1: orange, c2: green, c3: lightBlue, c4: blue};
				case 'Orange':
					return {c1: orange, c2: orange, c3: orange, c4: orange};
				case 'Green':
					return {c1: green, c2: green, c3: green, c4: green};
				case 'LightBlue':
					return {c1: lightBlue, c2: lightBlue, c3: lightBlue, c4: lightBlue};
				case 'Blue':
					return {c1: blue, c2: blue, c3: blue, c4: blue};
				case 'White':
					return {c1: 'white', c2: 'white', c3: 'white', c4: 'white'};
				default:
					return {c1: 'black', c2: 'black', c3: 'black', c4: 'black'};
			}
		}();
		...
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$width(x),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height(y),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _lucamug$elm_autocomplete_wrapper$Main$logoElmOriginal = F2(
	function (x, y) {
		var p = _elm_lang$svg$Svg_Attributes$points;
		var f = _elm_lang$svg$Svg_Attributes$fill;
		return A2(
			_elm_lang$svg$Svg$svg,
			{
			...
			},
			{
				...
				_0: A2(
					_elm_lang$svg$Svg$polygon,
					{
						...
						_1: {
							ctor: '::',
							_0: p('161.649,152.782 231.514,82.916 91.783,82.916'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						_elm_lang$svg$Svg$polygon,
						{
							...
							_1: {
								ctor: '::',
								_0: p('8.867,0 79.241,70.375 232.213,70.375 161.838,0'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
						...
						_1: {
							...
							_0: A2(
								_elm_lang$svg$Svg$polygon,
								{
									...
									_1: {
										ctor: '::',
										_0: p('323.298,143.724 323.298,0 179.573,0'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									_elm_lang$svg$Svg$polygon,
									{
										...
										_1: {
											ctor: '::',
											_0: p('152.781,161.649 0,8.868 0,314.432'),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
								_1: {
									...
									_0: A2(
										_elm_lang$svg$Svg$polygon,
										{
											...
											_1: {
												ctor: '::',
												_0: p('255.522,246.655 323.298,314.432 323.298,178.879'),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
									_1: {
										...
										_0: A2(
											_elm_lang$svg$Svg$polygon,
											{
												...
												_1: {
													ctor: '::',
													_0: p('161.649,170.517 8.869,323.298 314.43,323.298'),
													_1: {ctor: '[]'}
												}
											},
											{ctor: '[]'}),
...
var _lucamug$elm_autocomplete_wrapper$Main$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(_lucamug$elm_autocomplete_wrapper$Main$logoElmOriginal, '200px', '200px'),
			_1: {
				ctor: '::',
				_0: A3(_lucamug$elm_autocomplete_wrapper$Main$logoElm, _lucamug$elm_autocomplete_wrapper$Main$Colored, '200px', '200px'),
				_1: {
					ctor: '::',
					_0: A3(_lucamug$elm_autocomplete_wrapper$Main$logoElm, _lucamug$elm_autocomplete_wrapper$Main$Orange, '200px', '200px'),
					_1: {
						ctor: '::',
						_0: A3(_lucamug$elm_autocomplete_wrapper$Main$logoElm, _lucamug$elm_autocomplete_wrapper$Main$Green, '200px', '200px'),
						_1: {
							ctor: '::',
							_0: A3(_lucamug$elm_autocomplete_wrapper$Main$logoElm, _lucamug$elm_autocomplete_wrapper$Main$LightBlue, '200px', '200px'),
							_1: {
								ctor: '::',
								_0: A3(_lucamug$elm_autocomplete_wrapper$Main$logoElm, _lucamug$elm_autocomplete_wrapper$Main$Blue, '200px', '200px'),
								_1: {
									ctor: '::',
									_0: A3(_lucamug$elm_autocomplete_wrapper$Main$logoElm, _lucamug$elm_autocomplete_wrapper$Main$White, '200px', '200px'),
									_1: {
										ctor: '::',
										_0: A3(_lucamug$elm_autocomplete_wrapper$Main$logoElm, _lucamug$elm_autocomplete_wrapper$Main$Black, '200px', '200px'),
										_1: {ctor: '[]'}
									}
								}
							}
...
if (typeof _lucamug$elm_autocomplete_wrapper$Main$main !== 'undefined') {
    _lucamug$elm_autocomplete_wrapper$Main$main(Elm['Main'], 'Main', {"types":{"unions":{},"aliases":{},"message":"msg"},"versions":{"elm":"0.18.0"}});
}
