...
var _lucamug$elm_autocomplete_wrapper$Main$update = F2(
	function (msg, model) {
		...
		var search = A2(_mdgriffith$style_elements$Element_Input$updateSelection, _p0._0, model.search);
		return {
			ctor: '_Tuple2',
...
var _lucamug$elm_autocomplete_wrapper$Main$Model = function (a) {
	return {search: a};
};
var _lucamug$elm_autocomplete_wrapper$Main$Flave = {ctor: 'Flave'};
var _lucamug$elm_autocomplete_wrapper$Main$SubMenu = {ctor: 'SubMenu'};
var _lucamug$elm_autocomplete_wrapper$Main$Field = {ctor: 'Field'};
var _lucamug$elm_autocomplete_wrapper$Main$Page = {ctor: 'Page'};
var _lucamug$elm_autocomplete_wrapper$Main$None = {ctor: 'None'};
var _lucamug$elm_autocomplete_wrapper$Main$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_lucamug$elm_autocomplete_wrapper$Main$None,
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
				_mdgriffith$style_elements$Style$style,
				_lucamug$elm_autocomplete_wrapper$Main$Page,
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_mdgriffith$style_elements$Style$style,
					_lucamug$elm_autocomplete_wrapper$Main$Field,
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_mdgriffith$style_elements$Style$style,
						_lucamug$elm_autocomplete_wrapper$Main$SubMenu,
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Border$rounded(5),
							_1: {
...
var _lucamug$elm_autocomplete_wrapper$Main$view = function (model) {
	return A2(
		...
		_lucamug$elm_autocomplete_wrapper$Main$stylesheet,
		A3(
			...
			A3(
				...
				},
				{
					...
					_0: A3(
						...
						_lucamug$elm_autocomplete_wrapper$Main$None,
						{ctor: '[]'},
						_mdgriffith$style_elements$Element$text('Autocompete with Style Elements')),
					_1: {
						ctor: '::',
						_0: A3(
							...
							{
								label: _mdgriffith$style_elements$Element_Input$hiddenLabel('American State'),
								$with: model.search,
								options: {ctor: '[]'},
								max: 50,
								menu: A3(
									...
									A2(
										...
										function (item) {
											return A2(
												...
												item,
												_mdgriffith$style_elements$Element$text(item));
										},
										_lucamug$elm_autocomplete_wrapper$Main$menuItems1))
							}),
						_1: {ctor: '[]'}
					}
				})));
};
var _lucamug$elm_autocomplete_wrapper$Main$Search = function (a) {
...
var _lucamug$elm_autocomplete_wrapper$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: {
				search: A2(_mdgriffith$style_elements$Element_Input$autocomplete, _elm_lang$core$Maybe$Nothing, _lucamug$elm_autocomplete_wrapper$Main$Search)
			},
			_1: _elm_lang$core$Platform_Cmd$none
		},
		update: _lucamug$elm_autocomplete_wrapper$Main$update,
		view: _lucamug$elm_autocomplete_wrapper$Main$view,
...
if (typeof _lucamug$elm_autocomplete_wrapper$Main$main !== 'undefined') {
    _lucamug$elm_autocomplete_wrapper$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Element.Input.SelectMsg":{"args":["opt"],"tags":{"Batch":["List (Element.Input.SelectMsg opt)"],"SelectFocused":[],"Clear":[],"OpenMenu":[],"CloseMenu":[],"SetQuery":["String"],"SelectValue":["Maybe.Maybe opt"],"SetFocus":["Maybe.Maybe opt"]}},"Main.Msg":{"args":[],"tags":{"Search":["Element.Input.SelectMsg String"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
